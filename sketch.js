...
fill("yellow")
textSize(24)
text("Save the balloon from the bees and ", 800,50)
text("touch the coins with the balloon to score points", 800,90)
...
fill("yellow")
textSize(30)
text("Press Space to restart the game", 400,220)
